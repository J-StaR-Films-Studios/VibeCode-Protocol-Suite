...
GPT-6 Astra, Sol, and Luna use OpenAI Standard short-context API rates. The router caps their advertised context at 240K tokens, below the 272K long-context pricing threshold. Codex OAuth access still depends on the account and rollout. See [OpenAI's Codex model list](https://developers.openai.com/codex/models).
